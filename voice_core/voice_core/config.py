...
class Settings:
    ...
    system_prompt: str = os.getenv(
        ...
        (
            ...
            "Для поиска актуальной информации в интернете используй search_web, только если этот инструмент "
            "доступен в текущем запросе. Не утверждай, что выполнил поиск, без результата инструмента. "
