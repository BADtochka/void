...
from .tooling import DEFAULT_SYSTEM_PROMPT
...
class Settings:
    ...
    stop_phrases: tuple[str, ...] = _casefold_csv(
        ...
        "на этом закончим,на этом всё,на этом все,давай закончим,давай завершим,"
        "закончим разговор,завершим разговор,закончим диалог,больше не слушай,"
